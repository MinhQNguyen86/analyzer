...
extern EIF_TYPED_VALUE F1071_10372(EIF_REFERENCE);
static EIF_TYPED_VALUE F1071_10373_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1071_10373(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1071_10372 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1070, Current, 1, 0, 16716);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1070, Current, 16716);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 8158, 0xF8000533, 0); /* change_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1071_10373_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1070, Current, 0, 0, 16717);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1070, Current, 16717);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1071_10373 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(8158, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1071_10373_body (Current)).it_r;
