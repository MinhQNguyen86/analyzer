...
static const struct desc_info desc_1281[] = {
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 19472, 32},
	{EIF_NON_GENERIC(0x0197 /*203*/), 19473, 33},
	{EIF_GENERIC(egt_14_1281), 19474, 0},
	{EIF_GENERIC(egt_15_1281), 19475, 8},
	{EIF_GENERIC(egt_16_1281), 19476, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 19477, 36},
	{EIF_GENERIC(egt_17_1281), 19478, 24},
};
void Init1281(void)
{
