...
/* {EV_ID_IMP}.make_id */
void F1270_13083 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1269, Current, 0, 0, 19329);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1269, Current, 0, 0, 19331);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1270_25566 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1269, Current, 0, 25565);
	RTSA(dtype);
	RTME(dtype, 0);
