...
extern EIF_TYPED_VALUE F1677_18638(EIF_REFERENCE);
extern void F1677_18639(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1677_18638 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1677_18639 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1676, Current, 0, 0, 25282);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1676, Current, 25282);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14797, 0xF80006FD, 0); /* implementation */
