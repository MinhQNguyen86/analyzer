...
extern EIF_TYPED_VALUE F1669_18604(EIF_REFERENCE);
extern void F1669_18605(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1669_18604 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1669_18605 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1668, Current, 0, 0, 25248);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1668, Current, 25248);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14797, 0xF80006F7, 0); /* implementation */
