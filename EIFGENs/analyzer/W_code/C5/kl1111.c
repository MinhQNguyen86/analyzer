...
extern EIF_TYPED_VALUE F1111_10705(EIF_REFERENCE);
...
RTOID (F1111_10705)
EIF_TYPED_VALUE F1111_10705 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1110, Current, 0, 0, 17030);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1110, Current, 17030);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
