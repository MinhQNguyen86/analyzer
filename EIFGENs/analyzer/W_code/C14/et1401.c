...
extern void F1401_14506(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1401_14506 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1400, Current, 0, 1, 21032);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1400, Current, 21032);
	RTIV(Current, RTAL);
	RTHOOK(1);
