...
extern void F1405_14512(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1405_14512 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1404, Current, 0, 1, 21036);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1404, Current, 21036);
	{
