...
extern void F1403_14509(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1403_14509 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1402, Current, 0, 1, 21034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1402, Current, 21034);
	RTIV(Current, RTAL);
	RTHOOK(1);
