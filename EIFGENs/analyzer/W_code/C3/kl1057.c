...
extern EIF_TYPED_VALUE F1057_10137(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1057_10138(EIF_REFERENCE);
...
RTOID (F1057_10137)
EIF_TYPED_VALUE F1057_10137 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1056, Current, 0, 0, 16481);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1056, Current, 16481);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F1057_10138)
EIF_TYPED_VALUE F1057_10138 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1056, Current, 0, 0, 16482);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1056, Current, 16482);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (10137,F1057_10137)
	RTOTS (10138,F1057_10138)
}
