...
extern EIF_TYPED_VALUE F1169_11857(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1169_11858(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1169_11859(EIF_REFERENCE);
...
RTOID (F1169_11857)
EIF_TYPED_VALUE F1169_11857 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1168, Current, 0, 0, 18156);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1168, Current, 18156);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000716, 0,0); /* Result */
...
RTOID (F1169_11858)
EIF_TYPED_VALUE F1169_11858 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1168, Current, 0, 0, 18157);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1168, Current, 18157);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000716, 0,0); /* Result */
...
RTOID (F1169_11859)
EIF_TYPED_VALUE F1169_11859 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1168, Current, 0, 0, 18158);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1168, Current, 18158);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000716, 0,0); /* Result */
...
void EIF_Minit1169 (void)
{
	...
	RTOTS (11857,F1169_11857)
	RTOTS (11858,F1169_11858)
	RTOTS (11859,F1169_11859)
}
