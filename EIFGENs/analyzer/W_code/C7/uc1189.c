...
extern EIF_TYPED_VALUE F1189_12108(EIF_REFERENCE);
...
RTOID (F1189_12108)
EIF_TYPED_VALUE F1189_12108 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1188, Current, 0, 0, 18407);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1188, Current, 18407);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
