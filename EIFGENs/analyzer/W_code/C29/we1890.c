...
extern void F1890_22074(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F1890_22084(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1890_22085(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1890_22086(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F1890_22093(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1890_22094(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1890_22095(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1890_25666(EIF_REFERENCE, int);
...
void F1890_22074 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1889, Current, 0, 1, 28028);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 18260, 0xF80005AC, 0); /* dc */
	tr1 = RTLNSMART(RTWCT(18260, dtype, Dftype(Current)).id);
	tp1 = *(EIF_POINTER *)(Current + RTWA(12310, dtype));
	up1 = tp1;
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(18270, dtype))(Current, up1x)).it_p);
	up1 = tp1;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1889, Current, 0, 0, 28030);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1889, Current, 0, 0, 28031);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(12310, dtype));
	up1 = tp1;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(18266, dtype))(Current, up1x)).it_i4);
	Result = (EIF_INTEGER_32) ti4_1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1889, Current, 0, 0, 28032);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1889, Current, 28032);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	tp1 = *(EIF_POINTER *)(Current + RTWA(12310, dtype));
	up1 = tp1;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(18267, dtype))(Current, up1x)).it_i4);
	Result = (EIF_INTEGER_32) ti4_1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
#define up1 up1x.it_p
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(12310, dtype));
	up1 = tp1;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(18268, dtype))(Current, up1x)).it_i4);
	Result = (EIF_INTEGER_32) ti4_1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1889, Current, 1, 0, 28034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(18253, dtype))(Current)).it_i4);
...
body:;
	...
	loc1 = RTCCL(tr1);
	loc1 = RTRV(RTWCT(18258, dtype, Dftype(Current)),loc1);
	if (EIF_TEST(loc1)) {
		RTHOOK(3);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1889, Current, 1, 0, 28035);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1889, Current, 0, 0, 28037);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(12310, dtype));
	up1 = tp1;
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(18271, dtype))(Current, up1x)).it_p);
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(12309, Dtype(tr1)))(tr1, up1x);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
...
EIF_TYPED_VALUE F1890_22084 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1889, Current, 0, 0, 28038);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(12310, dtype));
	up1 = tp1;
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(18272, dtype))(Current, up1x)).it_p);
...
RTOID (F1890_22085)
EIF_TYPED_VALUE F1890_22085 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1890_22085);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1889, Current, 0, 0, 28039);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(18263, dtype))(Current)).it_i4);
	Result = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F1890_22086 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1889, Current, 0, 0, 28040);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1889, Current, 0, 1, 28046);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1889, Current, 28046);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1890_22093 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
EIF_TYPED_VALUE F1890_22094 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1889, Current, 0, 1, 28048);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1889, Current, 28048);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1890_22095 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1889, Current, 0, 1, 28049);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1889, Current, 28049);
	RTIV(Current, RTAL);
...
void F1890_25666 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1889, Current, 0, 25665);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	if ((EIF_BOOLEAN)(tr1 != NULL)) {
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(18260, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(11582, "exists", tr1))(tr1)).it_b);
		tb1 = tb2;
	}
	if (tb1) {
		RTCK;
