...
void Init1430(void)
{
	...
	IDSC(desc_1430 + 32, 1012, 1429);
	IDSC(desc_1430 + 43, 734, 1429);
	IDSC(desc_1430 + 56, 594, 1429);
	IDSC(desc_1430 + 57, 596, 1429);
	IDSC(desc_1430 + 60, 598, 1429);
	IDSC(desc_1430 + 61, 589, 1429);
	IDSC(desc_1430 + 62, 732, 1429);
}
