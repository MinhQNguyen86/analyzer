...
extern EIF_TYPED_VALUE F1351_14277(EIF_REFERENCE);
...
RTOID (F1351_14277)
EIF_TYPED_VALUE F1351_14277 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1350, Current, 0, 0, 20804);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1350, Current, 20804);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
