...
extern EIF_TYPED_VALUE F1855_21026(EIF_REFERENCE);
...
RTOID (F1855_21026)
EIF_TYPED_VALUE F1855_21026 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F1855_21026);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1854, Current, 0, 0, 27003);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1854, Current, 27003);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
