...
extern EIF_TYPED_VALUE F1727_19461(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1727_19462(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1727_19463(EIF_REFERENCE);
extern void F1727_19464(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1727_19465(EIF_REFERENCE);
extern void F1727_19466(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1727_19461 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1726, Current, 2, 0, 25891);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc2)) {
		...
		if (RTAL & CK_CHECK) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16228, dtype))(Current)).it_b);
			if (tb2) {
				RTCK;
			} else {
				RTCF;
...
EIF_TYPED_VALUE F1727_19462 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1726, Current, 3, 0, 25892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc3)) {
		...
		for (;;) {
			...
			RTNHOOK(5,1);
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16228, "is_selected", tr1))(tr1)).it_b);
			if (tb2) {
				RTHOOK(6);
...
EIF_TYPED_VALUE F1727_19463 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(16232,Dtype(Current)));
	return r;
}


/* {EV_RADIO_PEER_IMP}.set_radio_group */
void F1727_19464 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1726, Current, 2, 1, 25894);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1726, Current, 25894);
	RTCC(arg1, 1726, l_feature_name, 1, RTWCT(16232, dtype, dftype), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN)(tr1 != NULL)) {
		RTHOOK(4);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(16234, dtype))(Current);
	}
	RTHOOK(5);
	ur1 = RTCCL(arg1);
...
void F1727_19465 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1726, Current, 1, 0, 25895);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1726, Current, 25895);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	RTHOOK(9);
	RTDBGAA(Current, dtype, 16232, 0xF80003A1, 0); /* radio_group */
...
void F1727_19466 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1726, Current, 0, 1, 25896);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1726, Current, 25896);
	RTCC(arg1, 1726, l_feature_name, 1, RTWCT(16232, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16232, 0xF80003A1, 0); /* radio_group */
	tr1 = RTCCL(arg1);
