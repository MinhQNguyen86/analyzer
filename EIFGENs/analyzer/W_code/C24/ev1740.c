...
extern EIF_TYPED_VALUE F1740_19512(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1740_19513(EIF_REFERENCE);
extern void F1740_19514(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1740_19512 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1740_19513 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(16269,Dtype(Current)));
	return r;
}


/* {EV_TEXT_ALIGNABLE_IMP}.align_text_center */
void F1740_19514 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1739, Current, 0, 0, 25927);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1739, Current, 25927);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1740_19515 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1739, Current, 0, 0, 25928);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1739, Current, 25928);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16269, 0x10000000, 1); /* text_alignment */
...
void F1740_19516 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1739, Current, 0, 0, 25929);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1739, Current, 25929);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16269, 0x10000000, 1); /* text_alignment */
