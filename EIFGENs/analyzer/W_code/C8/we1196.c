...
extern EIF_TYPED_VALUE F1196_12192(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1196_12193(EIF_REFERENCE);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1195, Current, 0, 0, 18473);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1195, Current, 18473);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1196_12192 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
RTOID (F1196_12193)
EIF_TYPED_VALUE F1196_12193 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1195, Current, 0, 0, 18475);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1195, Current, 18475);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	ur1 = tr3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(18759, Dtype(tr2)))(tr2, ur1x);
	RTNHOOK(1,1);
	ur1 = RTCCL(tr2);
