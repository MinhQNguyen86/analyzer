...
extern EIF_TYPED_VALUE F1926_23106(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1926_23107(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1926_23106 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1925, Current, 0, 0, 29048);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1925, Current, 29048);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9857, dtype))(Current)).it_i4);
	ui4_1 = ti4_2;
	ti4_2 = eif_bit_or(ti4_1,ui4_1);
...
EIF_TYPED_VALUE F1926_23107 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1925, Current, 0, 0, 29049);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1925, Current, 29049);
	RTIV(Current, RTAL);
	RTHOOK(1);
